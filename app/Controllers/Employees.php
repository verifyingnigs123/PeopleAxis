...
class Employees extends BaseController
{
    ...
    public function store()
    {
        ...
        $rules = [
            ...
            'rfid_number'     => 'permit_empty|max_length[100]|is_unique[employees.rfid_number]',
    ...
    public function update($id)
    {
        ...
        $rules = [
            ...
            'rfid_number'    => ['label' => 'RFID Number',    'rules' => 'permit_empty|max_length[100]|is_unique[employees.rfid_number,id,' . $id . ']'],
