...
<div class="department-display-shell">
...
<div class="page-header">
    <div>
        <h1><i class="fas fa-building"></i> Department Report</h1>
        <p>Department-wise employee distribution and organizational structure</p>
    </div>
</div>
...
<div class="report-info">
    <div class="report-summary">
        <div class="summary-item">
            ...
            <div class="summary-value"><?= date('M Y', strtotime($reportData['generated_at'] ?? 'now')) ?></div>
        </div>
        <div class="summary-item">
...
<div class="report-table-container">
            ...
            <tbody>
                <?php foreach ($reportData['data'] as $record): ?>
                    <tr>
                        ...
                        <td>
                            <strong><?= htmlspecialchars($record['name'] ?? 'N/A') ?></strong>
                        </td>
                        <td><?= htmlspecialchars($record['description'] ?? 'No description') ?></td>
                        <td>
                            <span class="employee-count">
                                <?= $record['employee_count'] ?? 0 ?> employees
                            </span>
                        </td>
                        <td>
                            <span class="status-badge badge-<?= ($record['is_active'] ?? 0) ? 'active' : 'inactive' ?>">
                                <?= htmlspecialchars(($record['is_active'] ?? 0) ? 'Active' : 'Inactive') ?>
                            </span>
                        </td>
                    </tr>
                <?php endforeach; ?>
    ...
    <?php else: ?>
        <div class="empty-state">
            ...
            <p><strong>No department records found</strong></p>
            <p class="empty-note">There are no departments in the system.</p>
        </div>
    <?php endif; ?>
